...
# Load the responses/completions from ChatGPT (i.e., the Stability Diffusion prompts).
...
# dat.set_index("lucidity", append=True).swaplevel()
...
# a["lucid"] = a["lucid"] / r.loc["lucid"]
# a["non-lucid"] = a["non-lucid"] / r.loc["non-lucid"]
